...
custom_replies = {
    ...
    "墨魚壽司": "墨魚壽司..(口水)",
    "墨魚餅": "
                1.將鮮墨魚清洗乾淨，去除內臟，並保留墨囊。
                2.將鮮墨魚切成小塊，放入攪拌機中。
                3.加入切碎的蔥、薑和大蒜，然後將其攪拌成漿狀。
                4.將墨囊切開，取出墨汁，加入墨魚漿中，攪拌均勻。
                5.加入鹽、胡椒粉和麵粉，攪拌至混合均勻。
                6.將蛋液倒入墨魚漿中，攪拌均勻混合。
                7.將平底鍋加熱並加入足夠的油，溫度約為中高火。
                8.使用湯匙或手，將墨魚漿舀取一小部分，輕輕放入熱油中。
                9.炸至餅體呈現金黃色和脆口，然後用鍋鏟將其翻轉，再繼續炸另一面。
                10.當墨魚餅炸至兩面金黃且熟透時，用鍋鏟將其取出，瀝乾多餘的油。"
}
